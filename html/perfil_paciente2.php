...
// Obtener paciente si viene ?id=xx
...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    // Notas
    $conn->query("DELETE FROM notas WHERE paciente_id=$paciente_id"); // opcional: reemplazar todas
    ...
    echo "<div class='alert alert-success text-center'>Paciente guardado correctamente</div>";
